...
<!-- Mirrored from htmldemo.net/juta/juta-v1/frequently-question.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Nov 2023 06:08:03 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Frequently Questions || Juta - Ecommerce Bootstrap 5 Template</title>
    ...
    <body>
        ...
        <div class="wrapper frequently-question-page">
            <header>
                <!-- header-top start -->
                                ...
                                <div class="full-setting-area">
                                    <div class="top-dropdown">
                                        <ul>
                                            ...
                                            <li class="drodown-show"><span>Language:</span> <a href="#"><img src="img/icon/p-1.jpg" alt=""> English <i class="fa fa-angle-down"></i></a>
                                                <ul class="open-dropdown">
                                            ...
                                            <ul class="shopping-cart-wrapper">
                                                <li>
                                                    ...
                                                    <div class="shoping-product-details">
                                                        ...
                                                        <div class="remove">
                                                            <button title="Remove"><i class="ion-android-delete"></i></button>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                ...
                                <div class="main-menu-area">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="#">For women <i class="ion-ios-arrow-down"></i></a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="breadcrumb-list">
                                ...
                                <li class="breadcrumb-item active">Frequently Questions</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-wraper mt-90">
                <div class="container-fluid">
                    <div class="row">
                       <div class="col-lg-12 col-xl-10 offset-xl-1">
                            <div class="feequently-about-content mb-90">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xl-10 offset-xl-1">
                            <div class="faequently-area-inner">
                                <div class="faequently-accordion">
                                    <!--panel body start-->
                                    <h4 class="open">There are many variations of passages of most Lorem Ipsum ?</h4>
                                    ...
                                    <!--panel body end-->
                                    <!--panel body start-->
                                    <h4>Donec mattis finibus elit ut tristique?</h4>
                                    <div class="faequently-description">
                                        <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate, eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu viverra lobortis. Morbi gravida, nisi id fringilla ultricies, elit lorem eleifend lorem</p>
                                    </div>
                                    <!--panel body end-->
                                    <!--panel body start-->
                                    <h4>Vestibulum a lorem placerat, porttitor urna vel?</h4>
                                    <div class="faequently-description">
                                        <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate, eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu viverra lobortis. Morbi gravida, nisi id fringilla ultricies, elit lorem eleifend lorem</p>
                                    </div>
                                    <!--panel body end-->
                                    <!--panel body start-->
                                    <h4>Aenean elit orci, efficitur quis nisl at, accumsan?</h4>
                                    <div class="faequently-description">
                                        <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate, eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu viverra lobortis. Morbi gravida, nisi id fringilla ultricies, elit lorem eleifend lorem</p>
                                    </div>
                                    <!--panel body end-->
                                    <!--panel body start-->
                                    <h4>Pellentesque habitant morbi tristique senectus et netus?</h4>
                                    <div class="faequently-description">
                                        <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate, eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu viverra lobortis. Morbi gravida, nisi id fringilla ultricies, elit lorem eleifend lorem</p>
                                    </div>
                                    <!--panel body end-->
                                    <!--panel body start-->
                                    <h4>Nam pellentesque aliquam metus?</h4>
                                    <div class="faequently-description">
                                        <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate, eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu viverra lobortis. Morbi gravida, nisi id fringilla ultricies, elit lorem eleifend lorem</p>
                                    </div>
                                    <!--panel body end-->
                                    <!--panel body start-->
                                    <h4>Aenean elit orci, efficitur quis nisl at?</h4>
                                    <div class="faequently-description">
                                        <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate, eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu viverra lobortis. Morbi gravida, nisi id fringilla ultricies, elit lorem eleifend lorem</p>
                                    </div>
                                    <!--panel body end-->
                                    <!--panel body start-->
                                    <h4>Morbi gravida, nisi id fringilla ultricies, elit lorem?</h4>
                                    <div class="faequently-description">
                                        <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate, eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu viverra lobortis. Morbi gravida, nisi id fringilla ultricies, elit lorem eleifend lorem</p>
                                    </div>
                                    <!--panel body end-->
