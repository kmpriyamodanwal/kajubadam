                        ...
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           <thead>
                              <tr>
                                 <th width="1%">#</th>
                                 <th >Image</th>
                                 <th class="text-nowrap">Categorie Name</th>
                           ...
                           <tbody>
                              ...
                              foreach ($ALLDATA as $key => $data) 
                                 ...
                                 $categories = $this->crud->selectDataByMultipleWhere('categories',array('id'=>$data->cat_id,));
                                 // $subcategories = $this->crud->selectDataByMultipleWhere('sub_categories',array('id'=>$data->sub_cat_id,));
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td width="1%">
                                    <img src="<?php echo base_url($upload_path); ?><?php echo $data->thumb_img; ?>" class="rounded h-60px my-n1 mx-n1" width="100%"/>
                                 </td>
                                 <td class=""><?php if(!empty($categories[0]->name)){ echo $categories[0]->name;}else { echo 'Select First';} ?></td>
                                 <td class=""><?php echo $data->name; ?></td>
                                 <td class=""><?php echo $data->rating; ?></td>
                                 <td class=""><?php echo $data->sku; ?></td>
