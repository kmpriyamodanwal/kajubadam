                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="content" placeholder="Enter text ..." rows="12" required></textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3 bg-light">
                                    <label class="form-label"style="width: 100%;text-align: center; position: relative;border: 1px solid aliceblue;">Upload image
                                       ...
                                       <input style="display: none;" type="file" class="form-control" name="image"  id="imgInp" required>
                                   </label>
                                 </div>
                              </div>
