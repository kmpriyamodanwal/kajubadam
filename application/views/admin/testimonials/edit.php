                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name"  value="<?php echo $EDITDATA[0]->name; ?>" required>
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Position</label>
                                    <input type="text" class="form-control" name="position" value="<?php echo $EDITDATA[0]->position; ?>" required>
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Rating</label>
                                    <input type="number" class="form-control" name="rating" value="<?php echo $EDITDATA[0]->rating; ?>" required>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="content"   placeholder="Enter text ..." rows="12"><?php echo $EDITDATA[0]->content; ?></textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
