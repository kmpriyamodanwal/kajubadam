                        ...
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           <thead>
                              <tr>
                                 ...
                                 <th class="text-nowrap">Sub Title</th>
                                 <th class="text-nowrap">Type & Mobile/PC</th> -->
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td width="1%">
                                    ...
                                    if($data->type==1)
                                       { ?>
                                    <img src="<?php echo base_url($upload_path); ?><?php echo $data->image; ?>" class="rounded h-60px my-n1 mx-n1" />
                                    <?php } else {?>
                                       <video width="150" height="150"  muted loop autoplay>
                                         <source src="<?php echo base_url($upload_path); ?><?php echo $data->video; ?>" type="video/mp4">
                                       </video>
                                    <?php } ?>
                                 </td>
                                 <!-- <td class=""><?php echo $data->title; ?></td>
                                 <td class=""><?php echo $data->sub_title; ?></td>
                                 <td class=""><?php echo bannertype($data->type); ?><br><?php echo mobilepcbanner($data->mobile); ?> </td>
 -->
